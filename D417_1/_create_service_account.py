"""
Script Name: create_service_account.py
Purpose: Automates the provisioning of admin service accounts across 
...
Architecture Note: Leverages the custom 'network_manager' module (network_manager.py) to handle low-level Netmiko connections, vendor driver strategy patterns, and safe context-managed execution lifecycles.
"""
...
# Retrieve default administrative credentials and target service account details from environment variables with safe fallback values to prevent hardcoded secrets.
...
def main():
    ...
    establishes secure connections, provisions the service account, 
    and persists the active configuration state to primary flash.
    """
    print(f"\nStarting {TITLE}...")
