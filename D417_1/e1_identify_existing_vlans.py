"""
Script Name: identify_existing_vlans.py
...
# Retrieve service account credentials from environment variables with safe fallback values to prevent hardcoded secrets.
    ...
    for device in inventory.devices:
        ...
        try:
            ...
            with DeviceManager(
                ...
                for vlan in vlans:
                    print(f"    - {vlan['vlan_name']} (ID: {vlan['vlan_id']})")
